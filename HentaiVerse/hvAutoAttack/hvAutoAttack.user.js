...
(function init() {
    ...
    if (gE('#riddlecounter')) { // 需要答题
        ...
        if (g('option').pauseButton) {
            ...
            button.innerHTML = '<img src="data:image/png;base64," alt="auto_active.png">';
            button.className = 'pauseChange';
            button.style = 'border-top-width: 0px; border-left-width: 0px; border-right-width: 0px; padding-top: 0px; padding-left: 0px; padding-bottom: 0px; border-bottom-width: 0px; padding-right: 0px; background: none;'
...
function addStyle(lang) { // CSS
    ...
    const cssContent = [
        ...
        '.hvAALog{font-size:16px;}',
        '.hvAAButton{top:4px;left:1200px;position:absolute;z-index:9999;cursor:pointer;width:24px;height:24px;background:url(data:image/png;base64,) center no-repeat transparent;}',
        ...
        '.quickSiteBar{position:relative;top:0px;left:3px;font-size:18px;text-align:left;width:calc(30%);}',
...
function quickSite() { // 快捷站点
    ...
    quickSiteBar.innerHTML = '<span><a href="javascript:void(0);"class="quickSiteBarToggle">➣</a></span>';
    if (g('option').quickSite) {
        g('option').quickSite.forEach((site) => {
            quickSiteBar.innerHTML = `${quickSiteBar.innerHTML}<span title="${site.name}" style="display: none;"><a href="${site.url}"target="_blank">${(site.fav) ? `<img src="${site.fav}"class="favicon"></img>` : ''}${site.name}</a></span>`;
        });
    }
...
function main() { // 主程序
    if (getValue('disabled')) { // 如果禁用
        ...
        gE('#hvAABox2>button').innerHTML = '<img src="data:image/png;base64," alt="auto_off.png">';
        return;
    }
    g('end', false);
...
function pauseChange() { // 暂停状态更改
    if (getValue('disabled')) {
        if (gE('.pauseChange')) gE('.pauseChange').innerHTML = '<img src="data:image/png;base64," alt="auto_active.png">';
        delValue(0);
        main();
    } else {
        if (gE('.pauseChange')) gE('.pauseChange').innerHTML = '<img src="data:image/png;base64," alt="auto_off.png">';
...
function battleInfoType(type) { // 增加战役模式说明 
    switch (type) {
...
function battleInfo() { // 战斗战况
    ...
    gE('.hvAALog').innerHTML = [
        ...
        `<br><l0>战役模式</l0><l1>戰役模式</l1><l2>Type</l2>: ${battleInfoType(g('roundType'))}`, // 增加战役模式说明 
    ].join('');
